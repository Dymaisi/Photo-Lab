...
(this, function () {
    ...
    b = function (a) {
        ...
        if (this._el = document.getElementById(b), null !== this._el) {
            ...
            this._valClass = a.valueStrokeClass || "circles-valueStroke",
            this._maxValClass = a.maxValueStrokeClass || "circles-maxValueStroke",
    ...
    return b.prototype = {
        ...
        _generateText: function () {
            if (this._textContainer = document.createElement("div"), this._textContainer.className = this._textClass, this._styleText) {
                var a = {
                    position:"absolute",
                    left:0.4 * this._radius + "px",
                    justifyContent:"center",
                    textAlign: "center",
                    fontSize: 0.6 * this._radius + "px",
        ...
        _generatePath: function (a, b, c, d) {
            ...
            return e.setAttribute("fill", "transparent"),
            e.setAttribute("stroke", c),
            e.setAttribute("stroke-width", this._strokeWidth),
            e.setAttribute("d", this._calculatePath(a, b)),
        ...
        update: function (b, c) {
            ...
            i = h.getPercent(),
            j = 1;
            return this._value = Math.min(this._maxValue, Math.max(0, b)),
            c ? (d = h.getPercent(), e = d > i, j += d % 1, f = Math.floor(Math.abs(d - i) / j), g = c / f, function k(b) {
                if (e ? i += j : i -= j, e && i >= d || !e && d >= i)
